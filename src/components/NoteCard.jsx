  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all duration-300 flex flex-col h-full group relative overflow-hidden">
      ...
      <div className="flex justify-between items-start mb-3">
        <h3 className="font-bold text-lg text-slate-800 dark:text-white font-sans line-clamp-2 leading-tight transition-colors">
          {note.title}
        </h3>
      ...
      <div 
        className="text-slate-600 dark:text-slate-300 text-sm whitespace-pre-wrap flex-grow mb-4 opacity-90 line-clamp-4 transition-colors"
